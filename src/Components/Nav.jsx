  ...
  return (
    <header className="header" id='home'>
      ...
      <nav className="nav-links">
        ...
        <a className="install-btn" href='https://github.com/Lah-deh/PhisGuard_extension/archive/refs/heads/main.zip'>Get PhisGuard</a>
      </nav>
      ...
      <div className={`side-drawer ${isOpen ? 'open' : ''}`}>
        ...
        <a onClick={() => setIsOpen(false)} className="install-btn" href="https://github.com/Lah-deh/PhisGuard_extension/archive/refs/heads/main.zip">
          Get PhisGuard
        </a>
      </div>
    </header>
